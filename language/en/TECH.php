...
$LNG['tech'] = array(
 ...
 34 => 'Alliance Depot',
 44 => 'Missile Silo',
 35 => 'Shielded Metal Den',
 36 => 'Underground Crystal Den',
 37 => 'Seabed Deuterium Den',
...
35 => 'A portion of the metal stocks will be stored here safe from plundering. The Den does not expand the overall storage capacity.',
36 => 'A portion of the crystal stocks will be stored here safe from plundering. The Den does not expand the overall storage capacity.',
37 => 'A portion of the Deuterium stocks will be stored here safe from plundering. The Den does not expand the overall storage capacity.',
...
114 => 'By integrating the 4th and 5th dimensions it is now possible to research a new kind of drive that is more economical and efficient. Further development will increase the cargo capacity of some ships.',
...
204 => 'This is the first fighting ship all emperors will build. The light fighter is an agile ship.',
...
33 => 'The Terraformer increases the usable area on the planet.',
34 => 'The Alliance Depot offers the possibility to supply fuel to friendly fleets in orbit.',
35 => 'The capacity of the Metal Den shows how much metal is protected from plundering. The better the Den is upgraded, the more resources can be protected from attackers. Espionage probes cannot detect the upgrade level of a Den. The storage capacity is not expanded as a result of the Den.',
36 => 'The capacity of the Crystal Den shows how much crystal is protected from plundering. The better the Den is upgraded, the more resources can be protected from attackers. Espionage probes cannot detect the upgrade level of a Den. The storage capacity is not expanded as a result of the Den.',
37 => 'The capacity of the Deuterium Den shows how much Deuterium is protected from plundering. The better the Den is upgraded, the more resources can be protected from attackers. Espionage probes cannot detect the upgrade level of a Den. The storage capacity is not expanded as a result of the Den.',
41 => 'The moon has no atmosphere therefore a lunar base must be built before the settlement of other buildings.',
42 => 'The sensor array allows you to monitor fleet movements. The higher the stage, the greater is the range of the phalanx.',
43 => 'Jump gates are huge transmitters that are able to send large fleets without loss of time through the universe. With each level the time between jumps is decreased by 10%.',
44 => 'missile silos used for storage of rockets.',
